...
public class CliParser {
	...
	public static HashMap<JhttpOption, String> parseArguments(String[] args){
		if(args.length == 0){
			return null;
		}
	...
	private static void putEnumKeyAndValue(int index, String[] args, HashMap<JhttpOption, String> argMap){
	...
	private static String getValueIfValid(int index, String[] args){
		String value = null;
